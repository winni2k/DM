...
my $dm = DistributedMake::base->new( dryRun => 0, outputFile=>$test_dir.'/test.log', queue=>'localhost' );
...
$dm = DistributedMake::base->new( dryRun => 0, outputFile=>$test_dir.'/test.log', queue=>'localhost' );
